...
//		System.out.println (toString ()) ;
	...
	private int smallerChild(int i)
	{
		...
		// have 2 child
		if (heap[pos1].getValue() - (heap[pos2].getValue()) <= 0)
			return pos1 ;
		return pos2;
...
//			i = parent (pos) ;
//		}
		while (parent(i) >= 0 && heap[parent(i)].getValue() - (heap[i].getValue()) > 0)
		{
			swap(parent (i), i) ;
			i = parent (i) ;
		}
	...
	private void bubbleDown(int i)
	{
		...
		while (smallPos >= 0 && heap[smallPos].getValue() - (heap[pos].getValue()) < 0)
		{
